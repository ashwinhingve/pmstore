      ...
      <div className="mx-auto flex h-9 max-w-[1600px] xl:w-4/5 items-center justify-between px-4 text-xs sm:px-6 lg:px-8">
        <div className="flex items-center gap-5">
          ...
          <span className="hidden items-center gap-1.5 lg:inline-flex">
            <Clock className="h-3.5 w-3.5 text-[var(--brand-ink)]" aria-hidden="true" />
            {CONTACT.hours}
          </span>
        </div>
        <a
          href={CONTACT.phoneHref}
          className="inline-flex items-center gap-1.5 font-medium transition-colors duration-[var(--dur-fast)] hover:text-[var(--brand-ink)]"
        >
