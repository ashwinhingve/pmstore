 ...
 */
export function ProductImageSlider({ products }: { products: ProductCardData[] }) {
  const reduceMotion = useReducedMotion();
  if (products.length === 0) return null;

  if (reduceMotion) {
    return (
      <section className="bg-[var(--paper)] py-6 sm:py-8" aria-label="Featured medicines">
  ...
  return (
    <section className="overflow-hidden bg-[var(--paper)] py-6 sm:py-8" aria-label="Featured medicines">
      <div
