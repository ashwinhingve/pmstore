        ...
        <div className="container mx-auto px-4">
          <AnimatedSection direction="up" className="text-center max-w-4xl mx-auto">
            <div className="w-20 h-20 bg-[var(--mint)] rounded-full flex items-center justify-center mx-auto mb-6">
              <Truck className="w-10 h-10 text-[var(--ink)]" />
            </div>
          ...
          <div className="space-y-12">
              ...
              <div className="bg-[var(--paper)] rounded-[var(--radius-md)] p-8 border border-[var(--foil-soft)] shadow-[var(--shadow-card)]">
                ...
                <ul className="space-y-3 text-[var(--ink)]">
                  <li className="flex items-start gap-2">
                    <span className="text-[var(--mint)] font-bold mt-1">-</span>
            ...
            <AnimatedSection direction="up">
              <div className="bg-[var(--paper)] rounded-[var(--radius-md)] p-8 border border-[var(--foil-soft)] shadow-[var(--shadow-card)]">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="bg-[var(--mint-soft)] rounded-[var(--radius-md)] p-5 border border-[var(--mint)]">
                    <h3 className="font-semibold font-display text-[var(--mint)] mb-2">Metro Cities</h3>
                    <p className="text-3xl font-bold text-[var(--ink)]">3-5</p>
                    <p className="text-sm text-[var(--ink-70)]">business days</p>
                  </div>
                  <div className="bg-[var(--mint-soft)] rounded-[var(--radius-md)] p-5 border border-[var(--mint)]">
                    <h3 className="font-semibold font-display text-[var(--mint)] mb-2">Other Locations</h3>
            ...
            <AnimatedSection direction="up">
              <div className="bg-[var(--paper)] rounded-[var(--radius-md)] p-8 border border-[var(--foil-soft)] shadow-[var(--shadow-card)]">
                ...
                <ul className="space-y-3 text-[var(--ink)]">
                  <li className="flex items-start gap-2">
                    <span className="text-[var(--mint)] font-bold mt-1">1.</span>
                    After payment confirmation, we process your order immediately.
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-[var(--mint)] font-bold mt-1">2.</span>
                    A Delhivery shipment is created and you get a tracking number via email/SMS.
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-[var(--mint)] font-bold mt-1">3.</span>
                    Track your order in real-time from your account under &quot;My Orders&quot;.
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-[var(--mint)] font-bold mt-1">4.</span>
            ...
            <AnimatedSection direction="up">
              <div className="bg-[var(--paper)] rounded-[var(--radius-md)] p-8 border border-[var(--foil-soft)] shadow-[var(--shadow-card)]">
                ...
                <ul className="space-y-3 text-[var(--ink)]">
                  <li className="flex items-start gap-2">
                    <span className="text-[var(--ink-40)] font-bold mt-1">-</span>
            ...
            <AnimatedSection direction="up">
              <div className="bg-[var(--ink)] rounded-[var(--radius-md)] p-8 text-[var(--paper-card)]">
                ...
                <div className="flex flex-wrap gap-6">
                  <a href={CONTACT.emailHref} className="flex items-center gap-2 text-[var(--paper-card)] hover:text-[var(--mint)] transition">
                    <Mail className="w-5 h-5" />
                    {CONTACT.email}
                  </a>
                  <a href={CONTACT.phoneHref} className="flex items-center gap-2 text-[var(--paper-card)] hover:text-[var(--mint)] transition">
