        ...
        <div className="mx-auto w-full max-w-[1600px] xl:w-4/5 px-4 sm:px-6 lg:px-8">
          <AnimatedSection direction="up" className="mx-auto max-w-3xl text-center">
            ...
            <p className="text-lg leading-relaxed text-[var(--ink-10)] md:text-xl">
              {SITE_SHORT_NAME} has served Bhopal for over 20 years,
              dispensing quality medicines at generic prices. Our aim is simple: help every family
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
            <AnimatedSection direction="left">
              <div className="bg-[var(--paper-card)] rounded-[var(--radius-md)] p-10 shadow-[var(--shadow-sm)] hover:shadow-[var(--shadow-md)] transition-shadow duration-[var(--dur-fast)] h-full group border border-[var(--foil-soft)]">
                ...
                <p className="text-lg text-[var(--ink-70)] leading-relaxed">
                  Make quality prescription and OTC medicines accessible at affordable prices. We partner with trusted suppliers to dispense government-approved generic brands at 60–70% savings, backed by trained pharmacists and free home delivery.
                </p>
              </div>
            </AnimatedSection>
            ...
            <AnimatedSection direction="right">
              <div className="bg-[var(--paper-card)] rounded-[var(--radius-md)] p-10 shadow-[var(--shadow-sm)] hover:shadow-[var(--shadow-md)] transition-shadow duration-[var(--dur-fast)] h-full group border border-[var(--foil-soft)]">
                ...
                <p className="text-lg text-[var(--ink-70)] leading-relaxed">
                  Bridge every doctor and patient with trust. Expand from Bhopal to serve all of India, making affordable, quality medicines a reality and establishing healthcare affordability as a standard, not a luxury.
                </p>
              </div>
            </AnimatedSection>
          </div>
        ...
        <div className="mx-auto w-full max-w-[1600px] xl:w-4/5 px-4 sm:px-6 lg:px-8">
          <AnimatedSection className="text-center mb-16">
            ...
            <p className="text-[var(--ink-70)] mt-6 max-w-2xl mx-auto">
              We bring affordable, quality medicines to every household
            </p>
          </AnimatedSection>
          ...
          <StaggerContainer className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <StaggerItem>
              <div className="bg-[var(--paper-card)] rounded-[var(--radius-md)] p-8 shadow-[var(--shadow-sm)] hover:shadow-[var(--shadow-md)] transition-shadow duration-[var(--dur-fast)] group text-center h-full border border-[var(--foil-soft)]">
                ...
                <h3 className="text-xl font-bold font-display text-[var(--ink)] mb-3">Quality medicines</h3>
                <p className="text-[var(--ink-70)]">
        ...
        <div className="mx-auto w-full max-w-[1600px] xl:w-4/5 px-4 sm:px-6 lg:px-8">
          <AnimatedSection direction="up" className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl text-[var(--ink-70)] mb-8">
              Order quality medicines at 60–70% savings, with free home delivery and pharmacist verification.
            </p>
