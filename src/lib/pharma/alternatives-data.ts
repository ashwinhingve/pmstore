...
const STRIP_FIELDS =
  '_id name slug manufacturer price mrp packSize packUnit unitPrice stock averageRating totalReviews orderCount salts form compositionKey expiryDate images';
